...
if (isset($_SERVER['SERVER_NAME'])){
	if ($_SERVER['SERVER_NAME'] == 'www.clevvermail.com'
	    || $_SERVER['SERVER_NAME'] == 'clevvermail.com'
	    || $_SERVER['SERVER_NAME'] == 'app.clevvermail.com'
	) {
	    define('ENVIRONMENT', 'production');
	} else if ($_SERVER['SERVER_NAME'] == 'devcloud.clevvermail.com') {
	    define('ENVIRONMENT', 'development');
	} else if ($_SERVER['SERVER_NAME'] == 'dev.clevvermail.com') {
...
if (defined('ENVIRONMENT')) {
    switch (ENVIRONMENT) {
        case 'development':
        case 'development_markus':
        case 'development_maxi':
        case 'development_cloud':
 ...
 *
 */
$application_folder = 'system/virtualpost';
