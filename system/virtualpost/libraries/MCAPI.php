...
require_once 'MailchimpLib/Mailchimp.php';
...
class MCAPI {
    ...
    function __construct($config) {
        $this->mc = new Mailchimp($config['apikey']); //your api key here
    ...
    */
    ...
    function lists($filters=array (
        ...
        return $lists = $this->mc->lists->getList();
    ...
    function listSubscribe($id, $email_address, $merge_vars=NULL, $email_type='html', $double_optin=true, $update_existing=false, $replace_interests=true, $send_welcome=false) {
        ...
        return $this->mc->lists->subscribe($id, array('email'=>$email_address), $merge_vars, $email_type, false, true, $replace_interests, false);
    ...
    function callServer($method, $params) {
        ...
        log_message(APConstants::LOG_ERROR, 'MCAPI respsone: '.json_encode($response), FALSE);
