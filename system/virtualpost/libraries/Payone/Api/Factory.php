...
class Payone_Api_Factory
{
     ...
     * @return Payone_Api_Mapper_Response_GetInvoice
     */
    protected function buildMapperResponseUpdateUser()
    {
        $mapper = new Payone_Api_Mapper_Response_UpdateUser();
        return $mapper;
    }
     ...
     * @return Payone_Api_Service_Management_GetInvoice
     */
    public function buildServiceManagementUpdateUser()
    {
        $service = new Payone_Api_Service_Management_UpdateUser();
        $service->setAdapter($this->buildHttpClient());
        $service->setMapperResponse($this->buildMapperResponseUpdateUser());
        $service->setValidator($this->buildValidatorDefault());
        return $service;
