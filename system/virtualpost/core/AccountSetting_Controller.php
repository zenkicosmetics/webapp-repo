 ...
 */
class AccountSetting_Controller extends MY_Controller
{
    ...
    public function __construct ()
    {
        ...
        $frontend_theme = "account_setting2";
    ...
    private function _check_access ()
    {
        ...
        $ignored_pages = array(
                ...
                'device/get_data',
                'device/get_updates',
                'account/users/load_area_code_target',
        );
        ...
        if (! APContext::getAdminIdLoggedIn()) {
            ...
            $customer = $this->customer_m->get_by_many(
                    array(
