...
(function($){
 $.fn.idleTimeout = function(options) {
    var defaults = {
      ...
      showDialog: true,
	  dialogTitle: 'ClevverMail Security Warning.',
	  dialogText: 'Your current ClevverMail session is expired. For your security ClevverMail sessions automatically 30 minutes of inactivity.',
	  dialogButton: 'Click Here To Login'
    }
