	...
	<div class="ym-grid">
		...
		<div class="ym-g50 ym-gr">
			<div class="top-nav-right">
				...
				?>
				<div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url()?>cases"><?php language_e('them_phon_view_part_head_Servs')?></a></div>
                <?php
                ...
                ?>
                <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url() ?>office"><?php language_e('them_phon_view_part_head_OffiSpac')?></a></div>
				...
				<?php
				if ($module == 'phones' && (($controller === 'phones' && $method == 'index') || in_array($method, array('news', 'scans', 'instore', 'trash')))) {
					$cssClass = 'selected';
				} else {
					$cssClass = '';
				}
				?>
                <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url()?>phones" ><?php language_e('them_phon_view_part_head_Phon')?></a></div>
                <?php
				...
				?>
				<div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url()?>mailbox" ><?php language_e('them_phon_view_part_head_Post')?></a></div>
			</div>
			...
			<div id="top-search">
				<input type="text" id="mainSearchTextbox" placeholder="<?php language_e('them_phon_view_part_head_Seac')?>" /><i class="fa fa-search icon-search" aria-hidden="true"></i>
...
<div style="display: none;">
	<form ID="mainSearchForm" action="<?php echo base_url()?>mailbox/index" method="POST">
		<input type="hidden" name="p" value="<?php echo isset($current_postbox) ? $current_postbox : ""?>" />
