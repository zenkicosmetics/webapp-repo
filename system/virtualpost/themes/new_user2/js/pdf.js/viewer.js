...
var DEFAULT_SCALE = THEFILESCALE;
console.log('DEFAULT_SCALE: ' + DEFAULT_SCALE);
...
var PDFView = {
  ...
  // DungNT Update
  previewMode: function pdfViewZoomIn() {
    this.parseScale(0.18, true);
  },
  
  fullMode: function pdfViewZoomIn() {
    this.parseScale(0.75, true);
  },
  //DungNT Update
...
//#if !(FIREFOX || MOZCENTRAL)
    ...
    url += '&action=download#pdfjs.action=download';
