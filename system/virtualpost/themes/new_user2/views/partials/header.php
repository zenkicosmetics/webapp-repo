        ...
        <div class="ym-g50 ym-gr">
            <div class="top-nav-right">
                ...
                <?php if (APUtils::IsEnableCaseFunction()): ?>
                    ...
                    ?>
                    <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url() ?>cases"><?php language_e('them_user_view_part_head_Servs')?></a></div>
                <?php endif; ?>
                <?php
                ...
                ?>
                <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url() ?>office"><?php language_e('them_user_view_part_head_OffiSpac')?></a></div>
                <?php
                ...
                ?>
                <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url()?>phones" ><?php language_e('them_user_view_part_head_Phon')?></a></div>
                ...
                ?>
                <div><a class="<?php echo $cssClass; ?>" href="<?php echo base_url() ?>mailbox" ><?php language_e('them_user_view_part_head_Post')?></a></div>
            </div>
            ...
            <div id="top-search">
                <input type="text" id="mainSearchTextbox" placeholder="<?php language_e('them_user_view_part_head_Seac')?>" /><i class="fa fa-search icon-search" aria-hidden="true"></i>
