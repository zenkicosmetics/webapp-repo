...
if(! defined('FILE_CACHE_DIRECTORY') )          define ('FILE_CACHE_DIRECTORY', './system/virtualpost/cache');                             // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('NOT_FOUND_IMAGE') )               define ('NOT_FOUND_IMAGE', 'uploads/images/no_image.jpg');                                                         // Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )                   define ('ERROR_IMAGE', 'uploads/images/no_image.jpg');                                                                     // Image to serve if an error occurs instead of showing error message 
