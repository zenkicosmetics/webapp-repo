...
//$db['supper_admin']['hostname'] = 'localhost';
//$db['supper_admin']['username'] = 'root';
//$db['supper_admin']['password'] = '';
//$db['supper_admin']['database'] = 'clevvermail_supper';
...
$db[$active_group]['host_address'] = $db_config_row->host_address;
