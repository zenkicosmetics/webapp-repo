		...
		<tr>
			<td style="width: 30px">
				...
				echo form_checkbox(array(
					...
					'checked'=> array_key_exists($module->ModuleName, $edit_permissions),
					'title' => sprintf(lang('permissions:checkbox_tooltip_give_access_to_module'), $module->ModuleName),
				)); ?>
			</td>
			<td>
				<label class="inline" for="<?php echo $module->ModuleName; ?>">
			...
			<?php if ( ! empty($module->roles)): ?>
				...
				<label class="inline">
					<?php echo form_checkbox(array(
						'class' => 'select-rule',
						'name' => 'module_roles[' . $module->ModuleName . ']['.$role.']',
						'value' => true,
						'checked' => isset($edit_permissions[$module->ModuleName]) AND array_key_exists($role, (array) $edit_permissions[$module->ModuleName])
					)); ?>
					<?php echo lang($module->ModuleName.'.role_'.$role); ?>
				</label>
				<?php endforeach; ?>
			<?php endif; ?>
			</td>
