...
<script type="text/javascript">
    ...
    var THEFILEPATH = '<?php echo APContext::getFullBasePath()."scans/todo/get_preview_estamp?filePath=".$filePath; ?>';
    var THEFILESCALE = 0.8;
...
<!--#endif-->
<script src="<?php  echo APContext::getAssetPath().$web_path."js/pdf.js/viewer.js" ?>" type="text/javascript"></script>
<script src="<?php echo APContext::getAssetPath().$web_path."js/pdf.js/debugger.js" ?>" type="text/javascript"></script>
<script type="text/javascript">
...
<div id="outerContainer">
	...
	<div id="mainContainer">
		...
		<div id="viewerContainer" style="top: 1px;">
