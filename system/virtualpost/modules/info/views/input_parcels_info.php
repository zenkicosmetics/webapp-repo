...
<form id="input_parcels_info_form" action="<?php echo base_url() ?>info/input_parcels_info" method="post" class="parcels_info">
            ...
            <?php if ($parcels): ?>
                <?php foreach($parcels as $index => $parcel): ?>
                    ...
                    <tr class="<?php echo ($i % 2 == 0)? 'even' : 'odd'; ?> row-data">
                        ...
                        <td><input type="text" name="weight[]" class="input-width parcel-info" value="<?php echo APUtils::number_format($parcel->weight); ?>"/></td>
                        <td>kg</td>
