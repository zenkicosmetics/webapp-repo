...
<section class="item">		
		...
		<table class="table-list">
			...
			<?php if ($module['is_core']) continue; ?>
				<tr>
					<td class="collapse"><?php echo ($module['IsBackEnd'] AND $module['installed']) ? anchor('admin/'.$module['slug'], $module['name']) : $module['name']; ?></td>
					<td><?php echo $module['description']; ?></td>
					<td class="align-center"><?php echo $module['version']; ?></td>
					<td class="actions">
						<?php if ($module['installed']): ?>
							<?php if ($module['EnableFlag']): ?>
...
<section class="item">
		...
		<table class="table-list">
			...
			<?php if ( ! $module['is_core']) continue; ?>
				<tr>
					<td><?php echo $module['IsBackEnd'] ? anchor('admin/' .$module['slug'], $module['name']) : $module['name']; ?></td>
					<td><?php echo $module['description']; ?></td>
					<td class="align-center"><?php echo $module['version']; ?></td>
					<td class="actions">
					<?php if ($module['EnableFlag']): ?>
