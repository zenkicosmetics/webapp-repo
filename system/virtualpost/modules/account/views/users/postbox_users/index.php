<div class="ym-grid">
    <div id="cloud-body-wrapper" style="width: 99%;margin-left: 20px;">
        <h2 style="border: 0px;">Users Postbox  Management</h2>
        <span>
...
<div id="gridwraper" style="margin: 20px 0px 0px 20px;">
    <form id="searchUserForm" action="#" method="post">
        <div class="ym-grid">
            ...
            <input type="hidden" id="searchUserForm_current_product_type" value="postbox" />
        </div>
    </form>
...
<!-- Content for dialog -->
<div class="hide">
    <div id="addUser" title="Add Postbox User" class="input-form dialog-form">
    </div>
    <div id="editUser" title="Edit Postbox User" class="input-form dialog-form">
    </div>
...
<script>
    jQuery(document).ready(function ($) {
        ...
        GeneralUsers.init('<?php echo base_url(); ?>', 10, '<?php echo Settings::get(APConstants::DROPDOWN_LIST_CODE);?>', 'postbox');
