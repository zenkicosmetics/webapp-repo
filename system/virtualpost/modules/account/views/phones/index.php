...
<!-- Content for dialog -->
<div class="hide">
    <div id="addPhoneWindow" title="Add Target" class="input-form dialog-form"></div>
</div>

<script type="text/javascript" src="<?php echo $this->config->item('asset_url'); ?>system/virtualpost/modules/account/js/Phones.js"></script>
<script>
    jQuery(document).ready(function ($) {
        ...
        Phones.init('<?php echo base_url(); ?>', 10, '<?php echo Settings::get(APConstants::DROPDOWN_LIST_CODE);?>');
    });
